# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 12:24:03 2021
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton3.setText(_translate("MainWindow", "ExtraTreeClassifier"))
       
        self.label.setText(_translate("MainWindow", "Comparaison Decision Trees"))
        ...
        self.labe9.setText(_translate("MainWindow", "ETC"))
        self.labe10.setText(_translate("MainWindow",str(t_etc.timeit(1))))
        self.labe11.setText(_translate("MainWindow", str(etc.score(d,alphabet)*100)))
        self.labe12.setText(_translate("MainWindow", str(etc.score(d_test,alphabet_test)*100)))
       
        
        
        self.pushButton.clicked.connect(self.openFile)
        self.pushButton2.clicked.connect(self.DecisionTreeClassifier)
        self.pushButton3.clicked.connect(self.ExtraTreeClassifier)
    ...
    def ExtraTreeClassifier(self):
           self.label_7.setText("le resultat ExtraTreeClassifier : =====> "+str(etc.predict([self.Xi])))
...
def ExtraTreeClassifier(d,alphabet):
       ...
       etc = tree.ExtraTreeClassifier(criterion='entropy',random_state=0 )
       etc.fit(d,alphabet)
       return etc
...
def image_trait_app():
       d=[]
       for i in range(1,63):
            img = "C:/Users/asus/Desktop/master_sir/s8/TAAD/tp3/images/apprentissage/".__add__(i.__str__()).__add__(".png")
...
def temp_Apprendre()  :     
       ...
       temp_etc = timeit.Timer('ExtraTreeClassifier(d,alphabet)','from __main__ import ExtraTreeClassifier, d, alphabet')
       
       return temp_dtc,temp_etc
...
def image_trait_test():
     ...
     for i in range(1,42):
            img = "C:/Users/asus/Desktop/master_sir/s8/TAAD/tp3/images/TEST/".__add__(i.__str__()).__add__(".png")
            img = cv2.imread(img,0)
